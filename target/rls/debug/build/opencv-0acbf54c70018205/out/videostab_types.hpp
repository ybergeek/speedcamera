...
template struct Result<cv::videostab::ColorAverageInpainter*>;
...
template struct Result<cv::videostab::InpaintingPipeline*>;
template struct Result<cv::videostab::KeypointBasedMotionEstimator*>;
template struct Result<cv::videostab::LogToStdout*>;
template struct Result<cv::videostab::LpMotionStabilizer*>;
template struct Result<cv::videostab::MaskFrameSource*>;
template struct Result<cv::videostab::MoreAccurateMotionWobbleSuppressor*>;
...
template struct Result<cv::videostab::MotionStabilizationPipeline*>;
template struct Result<cv::videostab::NullDeblurer*>;
template struct Result<cv::videostab::NullFrameSource*>;
template struct Result<cv::videostab::NullInpainter*>;
template struct Result<cv::videostab::NullLog*>;
template struct Result<cv::videostab::NullOutlierRejector*>;
template struct Result<cv::videostab::NullWobbleSuppressor*>;
...
template struct Result<cv::videostab::SparsePyrLkOptFlowEstimator*>;
