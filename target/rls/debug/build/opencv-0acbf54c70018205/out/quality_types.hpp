...
template struct Result<cv::quality::QualityBRISQUE*>;
template struct Result<cv::quality::QualityGMSD*>;
template struct Result<cv::quality::QualityMSE*>;
template struct Result<cv::quality::QualityPSNR*>;
template struct Result<cv::quality::QualitySSIM*>;
