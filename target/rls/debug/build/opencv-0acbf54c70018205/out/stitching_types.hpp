...
template struct Result<cv::SphericalWarper*>;
template struct Result<cv::StereographicWarper*>;
template struct Result<cv::Stitcher::Status>;
template struct Result<cv::TermCriteria>;
template struct Result<cv::TransverseMercatorWarper*>;
...
template struct Result<cv::detail::CompressedRectilinearPortraitProjector*>;
template struct Result<cv::detail::CompressedRectilinearPortraitWarper*>;
template struct Result<cv::detail::CompressedRectilinearProjector*>;
template struct Result<cv::detail::CompressedRectilinearWarper*>;
template struct Result<cv::detail::CylindricalPortraitProjector*>;
template struct Result<cv::detail::CylindricalPortraitWarper*>;
template struct Result<cv::detail::CylindricalProjector*>;
...
template struct Result<cv::detail::FisheyeProjector*>;
...
template struct Result<cv::detail::MercatorProjector*>;
...
template struct Result<cv::detail::NoExposureCompensator*>;
template struct Result<cv::detail::NoSeamFinder*>;
template struct Result<cv::detail::PaniniPortraitProjector*>;
template struct Result<cv::detail::PaniniPortraitWarper*>;
template struct Result<cv::detail::PaniniProjector*>;
template struct Result<cv::detail::PaniniWarper*>;
template struct Result<cv::detail::PlanePortraitProjector*>;
template struct Result<cv::detail::PlanePortraitWarper*>;
template struct Result<cv::detail::PlaneProjector*>;
template struct Result<cv::detail::PlaneWarperGpu*>;
template struct Result<cv::detail::PlaneWarper*>;
template struct Result<cv::detail::SphericalPortraitProjector*>;
...
template struct Result<cv::detail::StereographicProjector*>;
template struct Result<cv::detail::StereographicWarper*>;
template struct Result<cv::detail::TransverseMercatorProjector*>;
template struct Result<cv::detail::TransverseMercatorWarper*>;
template struct Result<cv::detail::VoronoiSeamFinder*>;
